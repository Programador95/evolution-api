...
export class BaileysStartupService extends ChannelStartupService {
  ...
  try {
    // Placeholder: chamadas de voz não estão habilitadas nesta build
    console.log("Simulação de chamada: offerCall e terminateCall não disponíveis nesta versão.");
    return { id: 'simulated-call-id', to: jid };
  } catch (error) {
    return error;
  }
}
